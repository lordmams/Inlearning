...
class AnalyseDonneesEtudiants:
    ...
    def analyse_langages_preferes(self):
        ...
        plt.title(
            "Top 10 des Langages de Programmation Préférés",
            fontsize=14,
            fontweight="bold",
        )
    ...
    def analyse_modes_apprentissage(self):
        ...
        plt.pie(
            mode_dist.values, labels=mode_dist.index, autopct="%1.1f%%", startangle=90
        )
        plt.title(
            "Distribution des Modes d'Apprentissage", fontsize=14, fontweight="bold"
        )
        plt.axis("equal")
        plt.tight_layout()
    ...
    def analyse_niveaux_academiques(self):
        ...
        plt.title(
            "Distribution des Niveaux Académiques", fontsize=14, fontweight="bold"
        )
    ...
    def analyse_experience_professionnelle(self):
        ...
        plt.title(
            "Distribution de l'Expérience Professionnelle",
            fontsize=14,
            fontweight="bold",
        )
    ...
    def analyse_correlations(self):
        ...
        plt.title(
            "Corrélation Âge vs Expérience Professionnelle",
            fontsize=14,
            fontweight="bold",
        )
