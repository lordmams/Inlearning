...
InterestFormSet = inlineformset_factory(
    Preferences, Interest, form=InterestForm, extra=2, can_delete=True
)
...
FieldOfStudyFormSet = inlineformset_factory(
    AcademicBackground, FieldOfStudy, form=FieldOfStudyForm, extra=1, can_delete=True
)
...
JobFormSet = inlineformset_factory(
    ProfessionalBackground, Job, form=JobForm, extra=1, can_delete=True
)
...
ShortTermGoalFormSet = inlineformset_factory(
    Goals, ShortTermGoal, form=ShortTermGoalForm, extra=2, can_delete=True
)
...
LongTermGoalFormSet = inlineformset_factory(
    Goals, LongTermGoal, form=LongTermGoalForm, extra=2, can_delete=True
)
