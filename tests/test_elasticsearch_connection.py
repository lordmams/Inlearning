...
ELASTICSEARCH_API_KEY = "T2FIYU5Ka0J5U1pfX01EQTN5QzY6XzJoOVZRTHp4Wk9EZ0V1T0dNV0ZGQQ=="  # Votre API Key
...
def test_elasticsearch_connection():
    ...
    try:
        ...
        try:
            ...
            print(f"   • Indices: {health.get('active_primary_shards', 0)} shards actifs")
        except Exception as e:
        ...
        try:
            if client.indices.exists(index=ELASTICSEARCH_INDEX):
                ...
                print("   (Il sera créé automatiquement lors de la première indexation)")
        except Exception as e:
        ...
        try:
            ...
            if response.get('result') in ['created', 'updated']:
                ...
                delete_response = client.delete(index=ELASTICSEARCH_INDEX, id='test-connection-inlearning')
