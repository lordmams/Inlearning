...
urlpatterns = [
    ...
    path('courses/import/result/', views.course_import_result, name='course_import_result'),
    ...
    # Elasticsearch
    path('elasticsearch/status/', views.elasticsearch_status, name='elasticsearch_status'),
    path('elasticsearch/reindex/', views.reindex_courses, name='reindex_courses'),
    path('elasticsearch/import/', views.elasticsearch_import, name='elasticsearch_import'),
    path('download/template/', views.download_course_template, name='download_template'),
    ...
    path('api/consumer-status/', api_views.consumer_status_api, name='api_consumer_status'),
    path('api/consumer-health/', api_views.consumer_health_check, name='api_consumer_health'),
    
    # System Monitoring URLs
    path('monitoring/', views.system_monitoring, name='system_monitoring'),
    path('monitoring/check-health/', views.check_services_health, name='check_services_health'),
    path('monitoring/alert/<int:alert_id>/resolve/', views.resolve_alert, name='resolve_alert'),
    path('api/services-dashboard/', views.services_dashboard_api, name='services_dashboard_api'),
    ...
    path('logs/<str:service_name>/since/', views.service_logs_since, name='service_logs_since'),
