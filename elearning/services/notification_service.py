...
class NotificationService:
    ...
    def send_import_success_notification(self, filename: str, result: Dict[str, Any]):
        ...
        try:
            ...
            # Log local
            logger.info(f"Import success: {filename} - {result.get('imported_count', 0)} cours importés")
...
E-Learning Platform - Import Automation
    ...
    def _send_email(self, subject: str, message: str, priority: str = 'normal'):
        ...
        try:
            ...
            send_mail(
                subject=subject,
                message=message,
                from_email=getattr(settings, 'DEFAULT_FROM_EMAIL', 'noreply@elearning.com'),
    ...
    def _send_slack_notification(self, webhook_url: str, title: str, message: str, status: str):
    ...
    def _send_discord_notification(self, webhook_url: str, title: str, message: str, status: str):
    ...
    def _send_teams_notification(self, webhook_url: str, title: str, message: str, status: str):
    ...
    def _send_generic_webhook(self, webhook_url: str, title: str, message: str, status: str):
