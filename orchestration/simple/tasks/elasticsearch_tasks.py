...
def run_elasticsearch_reindex():
    ...
    try:
        ...
        es_host = os.getenv('ELASTICSEARCH_HOST', 'https://my-elasticsearch-project-d09d1e.es.us-central1.gcp.elastic.cloud:443')
        es_index = os.getenv('ELASTICSEARCH_INDEX', 'inlearning-storage')
        es_api_key = os.getenv('ELASTICSEARCH_API_KEY', 'T2FIYU5Ka0J5U1pfX01EQTN5QzY6XzJoOVZRTHp4Wk9EZ0V1T0dNV0ZGQQ==')
        ...
        if response.status_code == 200:
            ...
            logger.warning(f"Impossible d'obtenir les statistiques: {response.status_code}")
