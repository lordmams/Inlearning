...
class LogRetrievalService:
    ...
    def get_service_logs(self, service_name: str, lines: int = 100, since: Optional[str] = None) -> Dict:
        """
        ...
        try:
            ...
            if orchestration_logs.get('success') and orchestration_logs.get('logs'):
                for log_line in orchestration_logs['logs']:
                    ...
                    if any(keyword in log_line.lower() for keyword in ['etl', 'pipeline', 'task', 'scheduled']):
