...
class CourseImportForm(forms.Form):
    ...
    def clean_file(self):
        ...
        if file.size > 50 * 1024 * 1024:
            raise forms.ValidationError("Le fichier est trop volumineux. Taille maximale: 50MB")
...
class BatchActionForm(forms.Form):
    ...
    def clean_course_ids(self):
        ...
        try:
            ...
            ids_list = [int(id_str.strip()) for id_str in course_ids.split(',') if id_str.strip()]
            if not ids_list:
