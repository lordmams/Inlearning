...
class UserProfileView(LoginRequiredMixin, View):
    ...
    def get(self, request, pk=None):
        ...
        if pk:
            ...
            if (
                person.user
                and person.user != request.user
                and not request.user.is_staff
            ):
                messages.error(
                    request, "Vous n'êtes pas autorisé à modifier ce profil."
                )
        ...
        professional, created = ProfessionalBackground.objects.get_or_create(
            person=person
        )
    ...
    def post(self, request, pk=None):
        ...
        try:
            ...
            professional_form = ProfessionalBackgroundForm(
                professional_data, instance=professional
            )
            ...
            user_data = {
                ...
                "fields_of_study": (
                    academic.fields_of_study.first().field_name
                    if academic.fields_of_study.exists()
                    else None
                ),
            }
            ...
            return JsonResponse({"success": False, "global_errors": [str(e)]})
